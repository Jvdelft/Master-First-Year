...
@SET list=(LIBBATCH KERNEL GUI GEOM FIELDS MEDCOUPLING SMESH SHAPER YACS JOBMANAGER PARAVIS HEXABLOCK HEXABLOCKPLUGIN NETGENPLUGIN GHS3DPLUGIN HEXOTICPLUGIN BLSURFPLUGIN ATOMGEN ATOMIC ATOMSOLV PYCALCULATOR CALCULATOR COMPONENT LIGHT PYLIGHT RANDOMIZER SIERPINSKY PYHELLO HELLO HYBRIDPLUGIN)
...
@for %%i in %list% do ( 
  @SET %%i_ROOT_DIR=%SALOME_ROOT_DIR%\MODULES\INSTALL\%%i\RELEASE\%%i_INSTALL
)
